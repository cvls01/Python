# A versão 2 desse desafio é uma continuação da versão 1. Neste desafio, devemos implementar duas funções: 
# criar usuario e criar conta corrente. Também devemos aprimorar a estrutura e a eficiência do sistema, 
